...
public class Problem_56_Test {
    ...
    public void test1() {
        ...
        System.out.println(Arrays.deepToString(p.solve2(new int[][]{{1, 4}, {2, 6}, {3, 5}})));
    }
    @Test
    public void test2() {
        System.out.println(Arrays.deepToString(p.solve1(new int[][]{{1,3},{2,6},{8,10},{15,18}})));
        System.out.println(Arrays.deepToString(p.solve2(new int[][]{{1,3},{2,6},{8,10},{15,18}})));
    }
    @Test
    public void test3() {
        System.out.println(Arrays.deepToString(p.solve1(new int[][]{{1,4},{4,5}})));
        System.out.println(Arrays.deepToString(p.solve2(new int[][]{{1,4},{4,5}})));
    }
}
