...
public class Problem_198_Test {
    ...
    public void test1() {
        ...
        assertEquals(4, p2.solve2(new int[]{1,2,3,1}));
    }
    @Test
    public void test2() {
        ...
        assertEquals(12, p2.solve2(new int[]{2,7,9,3,1}));
    }
    @Test
    public void test3() {
        ...
        assertEquals(120, p2.solve2(new int[]{100,50,20}));
    }
    @Test
    public void test4() {
        ...
        assertEquals(4, p2.solve2(new int[]{2,1,1,2}));
    }
}
