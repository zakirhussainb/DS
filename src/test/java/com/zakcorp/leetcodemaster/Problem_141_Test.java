...
import com.zakcorp.grokking.coding.fastslowpointers.Chapter_2_1;
...
public class Problem_141_Test {
    ...
    Chapter_2_1 p1 = new Chapter_2_1();
    @Test
    public void test1() {
    ...
    @Test
    public void test2() {
        Chapter_2_1.ListNode head = new Chapter_2_1.ListNode(1);
        head.next = new Chapter_2_1.ListNode(2);
        head.next.next = new Chapter_2_1.ListNode(3);
        head.next.next.next = new Chapter_2_1.ListNode(4);
        head.next.next.next.next = new Chapter_2_1.ListNode(5);
        head.next.next.next.next.next = new Chapter_2_1.ListNode(6);
