...
import com.zakcorp.grokking.coding.twopointers.Chapter_4_2;
...
public class Problem_141_Test {
    ...
    Chapter_4_2 p1 = new Chapter_4_2();
    @Test
    public void test1() {
    ...
    @Test
    public void test2() {
        Chapter_4_2.ListNode head = new Chapter_4_2.ListNode(1);
        head.next = new Chapter_4_2.ListNode(2);
        head.next.next = new Chapter_4_2.ListNode(3);
        head.next.next.next = new Chapter_4_2.ListNode(4);
        head.next.next.next.next = new Chapter_4_2.ListNode(5);
        head.next.next.next.next.next = new Chapter_4_2.ListNode(6);
