...
public class Problem_746_Test {
    ...
    Problem_746.Solver3 p3 = new Problem_746.Solver3();
    @Test
    public void test1() {
//        assertEquals(6, p.solve1(new int[]{1, 100, 1, 1, 1, 100, 1, 1, 100, 1}));
        ...
        assertEquals(6, p3.solve1(new int[]{1, 100, 1, 1, 1, 100, 1, 1, 100, 1}));
        assertEquals(6, p3.solve2(new int[]{1, 100, 1, 1, 1, 100, 1, 1, 100, 1}));
    }
    @Test
    public void test2() {
//        assertEquals(6, p.solve1(new int[]{1, 100, 1, 1, 1, 100, 1, 1, 100, 1}));
        ...
        assertEquals(15, p3.solve1(new int[]{10, 15, 20}));
        assertEquals(15, p3.solve2(new int[]{10, 15, 20}));
    }
