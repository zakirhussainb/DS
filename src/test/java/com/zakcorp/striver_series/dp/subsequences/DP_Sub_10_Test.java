...
public class DP_Sub_10_Test {
    ...
    public void test2() {
        ...
        assertEquals(110, p3.solve1(new int[]{1, 3, 4, 5}, new int[]{10, 40, 50, 70},4, 8));
    }
    @Test
    public void test3() {
        ...
        assertEquals(360, p3.solve1(new int[]{10, 20, 30}, new int[]{60, 100, 120},3, 60));
    }
}
