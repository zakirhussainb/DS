...
//        assertEquals(3, p2.solve1(new int[]{1, 1, 2, 3}, 1));
    ...
    public void test4() {
        ...
        assertEquals(0, p3.solve1(new int[]{7,9,13,4,14,2,20,14,5,15,4}, 90));
    }
}
