...
public class DP_Strings_3_Test {
    ...
    DP_Strings_3.SpaceOptimization p2 = new DP_Strings_3.SpaceOptimization();

    @Test
    public void test1() {
        assertEquals(4, p1.solve1("eeeme"));
        assertEquals(4, p2.solve1("eeeme"));
    }

    @Test
    public void test2() {
        assertEquals(2, p1.solve1("annb"));
        assertEquals(2, p2.solve1("annb"));
    }

    @Test
    public void test3() {
        assertEquals(1, p1.solve1("s"));
        assertEquals(1, p2.solve1("s"));
    }

    @Test
    public void test4() {
        assertEquals(7, p1.solve1("bbabcbcab"));
        assertEquals(7, p2.solve1("bbabcbcab"));
    }
}
