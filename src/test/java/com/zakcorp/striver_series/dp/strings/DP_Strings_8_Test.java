...
public class DP_Strings_8_Test {
    ...
    DP_Strings_8.Tabulation p3 = new DP_Strings_8.Tabulation();

    @Test
    public void test1() {
        assertEquals(2, p1.solve1("planet", "plan"));
        assertEquals(2, p2.solve1("planet", "plan"));
        assertEquals(2, p3.solve1("planet", "plan"));
    }
    ...
    public void test2() {
        ...
        assertEquals(4, p3.solve1("abcdefg", "azced"));
    }
    ...
    public void test3() {
        ...
        assertEquals(3, p3.solve1("saturday", "sunday"));
    }
}
