...
public class Problem_693 {
    static class Solver {
        public boolean solve1(int n) {
            ...
            Now if we AND those two numbers, we can get the whole thing as zero but that won't work for numbers
            like 2, 4, 8... So we will take another approach. Instead of AND we will do an XOR . This will make all bits 1.
